...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2 style="color: #246bfe;">{{ $tugas->judul }}</h2>
            <p><strong>Batas Pengumpulan:</strong> {{ $tugas->batas_pengumpulan?->format('d F Y') ?? 'Tidak ada batas' }}</p>
            <p>{{ \Illuminate\Support\Str::limit($tugas->deskripsi, 150) }}</p>
            <p>Silakan login ke aplikasi untuk melihat lampiran PDF dan instruksi lengkapnya.</p>
            <p style="text-align: center;">
                <a href="{{ route('tugas.show', $tugas->id) }}" class="btn">Lihat Detail Tugas</a>
            </p>
        </div>
        <div class="footer">
