...
<head>
    ...
    <style>
        :root{--ink:#14213d;--muted:#738097;--blue:#246bfe;--surface:#f5f7fb;--danger:#d63f55;--top-height:70px;--bottom-height:0px}
        *{box-sizing:border-box}html,body{height:100%;margin:0}body{background:var(--surface);color:var(--ink);font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;overflow:hidden}
        .mobile-shell{width:100%;max-width:680px;height:100vh;margin:auto;overflow-y:auto;padding:calc(var(--top-height) + 12px) 0 calc(var(--bottom-height) + 16px);scroll-behavior:smooth}
