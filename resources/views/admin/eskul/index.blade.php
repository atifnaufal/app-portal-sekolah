                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-light rounded p-2" style="width: 50px; height: 50px;">
                            @if($eskul->logo)
                                <img src="{{ asset('storage/'.$eskul->logo) }}" class="w-100 h-100 object-fit-cover rounded">
                            @else
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pembina_id" class="form-select rounded-3">
                            ...
                            @foreach($gurus as $guru)
                                <option value="{{ $guru->id }}" {{ $eskul->pembina_id == $guru->id ? 'selected' : '' }}>{{ $guru->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group list-group-flush">
                        @forelse($eskul->members as $member)
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 border-light">
                                ...
                                <form action="{{ route('admin.eskul.set-admin', $eskul) }}" method="POST">
                                    ...
                                    <button class="btn btn-sm {{ $member->pivot->is_admin ? 'btn-success' : 'btn-outline-secondary' }} rounded-pill px-3">
