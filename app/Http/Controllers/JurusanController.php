...
class JurusanController extends Controller
{
    ...
    public function destroy(Jurusan $jurusan): RedirectResponse { if ($jurusan->mahasiswa()->exists()) return back()->with('error', 'Jurusan masih memiliki mahasiswa.'); $jurusan->delete(); return back()->with('success', 'Jurusan berhasil dihapus.'); }
}
