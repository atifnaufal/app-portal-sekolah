...
<div class="am-body">
    <div class="am-hero">
        <div style="position:relative;z-index:1;">
            ...
            <div style="font-size:22px;font-weight:800;margin-top:4px;">Halo, <?php echo e(explode(' ', session('admin_name') ?? 'Admin')[0]); ?>!</div>
            <div style="font-size:12px;opacity:0.65;margin-top:4px;"><?php echo e(now()->format('d M Y')); ?></div>

            <div style="display:flex;gap:8px;margin-top:16px;">
                <div class="am-stat"><div class="n"><?php echo e($totalGuru); ?></div><div class="l">Guru</div></div>
                <div class="am-stat"><div class="n"><?php echo e($totalSiswa); ?></div><div class="l">Siswa</div></div>
                <div class="am-stat"><div class="n"><?php echo e($totalKelas); ?></div><div class="l">Kelas</div></div>
                <div class="am-stat"><div class="n" style="color:#fca5a5;"><?php echo e($sppKurang); ?></div><div class="l">Tunggakan</div></div>
            </div>
        </div>
    </div>
    ...
    <?php if(session('info')): ?>
        <div class="am-note mb-3">
            ...
            <div style="font-size:12px;color:#1e40af;line-height:1.5;"><?php echo e(session('info')); ?></div>
        </div>
    <?php endif; ?>
    ...
    <div class="am-card">
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px;">
            <div style="background:#f5f8ff;border-radius:14px;padding:14px;text-align:center;">
                <div style="font-size:24px;font-weight:800;color:#2563eb;"><?php echo e($totalMapel); ?></div>
            ...
            <div style="background:#f0fdf4;border-radius:14px;padding:14px;text-align:center;">
                <div style="font-size:24px;font-weight:800;color:#16a34a;"><?php echo e($totalMateri); ?></div>
            ...
            <div style="background:#fffbeb;border-radius:14px;padding:14px;text-align:center;">
                <div style="font-size:24px;font-weight:800;color:#d97706;"><?php echo e($totalTugas); ?></div>
            ...
            <div style="background:#fff5f6;border-radius:14px;padding:14px;text-align:center;">
                <div style="font-size:24px;font-weight:800;color:<?php echo e($tugasBelumDinilai > 0 ? '#dc2626' : '#94a3b8'); ?>;"><?php echo e($tugasBelumDinilai); ?></div>
    ...
    <a href="<?php echo e(route('pengumuman.index')); ?>" class="am-action">
    ...
    <div class="am-card">
        ...
        <?php $pct = $sppTagihan > 0 ? round(($sppTerbayar / $sppTagihan) * 100) : 0; ?>
        <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:6px;">
            <span style="color:#64748b;font-weight:600;">Terbayar</span>
            <span style="font-weight:800;color:#16a34a;"><?php echo e($pct); ?>%</span>
        </div>
        <div style="height:8px;border-radius:99px;background:#f1f5f9;overflow:hidden;margin-bottom:12px;">
            <div style="height:100%;border-radius:99px;width:<?php echo e($pct); ?>%;background:linear-gradient(90deg,#16a34a,#4ade80);"></div>
        </div>
        <div style="display:flex;justify-content:space-between;">
            <div>
                <div style="font-size:10px;color:#94a3b8;font-weight:700;">TOTAL TAGIHAN</div>
                <div style="font-size:14px;font-weight:800;color:#1e293b;">Rp <?php echo e(number_format($sppTagihan, 0, ',', '.')); ?></div>
            </div>
            <div style="text-align:right;">
                <div style="font-size:10px;color:#94a3b8;font-weight:700;">SISA PIUTANG</div>
                <div style="font-size:14px;font-weight:800;color:#d97706;">Rp <?php echo e(number_format(max(0, $sppTagihan - $sppTerbayar), 0, ',', '.')); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="am-note">
        ...
        <div style="font-size:12px;color:#1e40af;line-height:1.6;">
            ...
            <span style="font-weight:700;word-break:break-all;"><?php echo e(url('/dashboard')); ?></span>
        </div>
    </div>
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\admin-dashboard.blade.php ENDPATH**/ ?>