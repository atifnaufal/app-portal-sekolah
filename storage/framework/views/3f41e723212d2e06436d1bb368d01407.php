    ...
    <div class="p-4 p-md-5">
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" value="<?php echo e(old('email', $email)); ?>" class="form-control" required>
            </div>
            <div class="mb-3">
        ...
        <div class="text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-decoration-none small fw-bold"><i class="bi bi-arrow-left"></i> Kembali ke Login</a>
        </div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>