...
<div class="row g-4 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="ad-stat">
            ...
            <div class="ad-stat-num"><?php echo e(number_format($totalNilai)); ?></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="ad-stat">
            ...
            <div class="ad-stat-num" style="display:flex;align-items:baseline;gap:4px;"><?php echo e($rataNilai); ?><span style="font-size:14px;color:#94a3b8;font-weight:700;">/100</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="ad-stat">
            ...
            <div class="ad-stat-num text-success"><?php echo e($hadirHariIni); ?></div>
            <div class="small text-muted mt-2"><i class="bi bi-calendar-check"></i> Present Today (Total <?php echo e($absensiHariIni); ?>)</div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="ad-stat">
            ...
            <div class="ad-stat-num"><?php echo e(number_format($totalPengumpulan)); ?></div>
            <div class="small text-muted mt-2"><i class="bi bi-check2-circle text-success"></i> <?php echo e(number_format($totalPengumpulanDinilai)); ?> Sudah Dinilai</div>
        </div>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (gradeCtx) {
            new Chart(gradeCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($gradeDist['A']); ?>, <?php echo e($gradeDist['B']); ?>, <?php echo e($gradeDist['C']); ?>, <?php echo e($gradeDist['D']); ?>, <?php echo e($gradeDist['E']); ?>],
        ...
        if (kelasCtx) {
            new Chart(kelasCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($kelasNames); ?>,
                    datasets: [{
                        label: 'Siswa', data: <?php echo json_encode($kelasSiswa); ?>,
        ...
        if (absensiCtx) {
            new Chart(absensiCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($distAbsensi['hadir']); ?>, <?php echo e($distAbsensi['terlambat']); ?>, <?php echo e($distAbsensi['izin']); ?>, <?php echo e($distAbsensi['sakit']); ?>, <?php echo e($distAbsensi['alpha']); ?>],
        ...
        if (regCtx) {
            ...
            new Chart(regCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Pendaftar', data: <?php echo json_encode($regCounts); ?>,
