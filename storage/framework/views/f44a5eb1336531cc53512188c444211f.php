...
<div class="reader-top-bar animate__animated animate__fadeInDown">
    <a href="<?php echo e(route('perpustakaan.show', $buku->slug)); ?>" class="btn-exit-reader">
        <i class="bi bi-x-lg"></i>
    </a>
    <div class="immersive-header-txt">
        <div class="book-name-small text-truncate"><?php echo e($buku->judul); ?></div>
...
<div class="reader-canvas">
    <?php if($buku->file_pdf): ?>
        ...
        <iframe
            class="pdf-frame"
            src="https://docs.google.com/viewer?url=<?php echo e(urlencode($pdfUrl)); ?>&embedded=true"
            allow="fullscreen"
        ></iframe>

        
        <div style="position: fixed; bottom: 80px; right: 20px; z-index: 1002;">
            <a href="<?php echo e($pdfUrl); ?>" download class="btn btn-primary rounded-circle shadow-lg d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
    ...
    <?php else: ?>
        <div class="pdf-fallback">
            ...
            <a href="<?php echo e(route('perpustakaan.show', $buku->slug)); ?>" class="btn btn-primary rounded-pill px-4 mt-3">Kembali</a>
        </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\perpustakaan\read.blade.php ENDPATH**/ ?>