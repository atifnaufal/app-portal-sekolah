...
<div class="perpus-hero">
    <div class="header-top">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-light rounded-circle shadow-sm" style="width: 44px; height: 44px; display: grid; place-items: center;">
            <i class="bi bi-grid-fill"></i>
        </a>
    </div>

    <form action="<?php echo e(route('perpustakaan.index')); ?>" method="GET">
        <div class="search-wrapper">
            <div class="ps-3"><i class="bi bi-search text-white opacity-40"></i></div>
            <input type="text" name="search" class="search-input" placeholder="Temukan bacaan cerdas..." value="<?php echo e(request('search')); ?>">
            <?php if(request('search')): ?>
                <a href="<?php echo e(route('perpustakaan.index')); ?>" class="pe-3 text-white opacity-40"><i class="bi bi-x-circle-fill"></i></a>
            <?php endif; ?>
        </div>
    </form>
</div>
...
<div class="category-scroll">
    <a href="<?php echo e(route('perpustakaan.index')); ?>" class="chip <?php echo e(!request('kategori') ? 'chip-active' : 'chip-inactive'); ?>">
        Semua Koleksi
    </a>
    <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('perpustakaan.index', ['kategori' => $kat->slug])); ?>" class="chip <?php echo e(request('kategori') == $kat->slug ? 'chip-active' : 'chip-inactive'); ?>">
            <?php echo e($kat->nama); ?>
...
<div class="grid-container">
    <div class="row g-3">
        ...
        <div class="col-6 col-sm-4">
            <a href="<?php echo e(route('perpustakaan.show', $buku->slug)); ?>" class="text-decoration-none">
                <div class="book-card-premium">
                    <div class="cover-box">
                        <?php if($buku->cover): ?>
                            <img src="<?php echo e(asset('storage/'.$buku->cover)); ?>" class="cover-img" loading="lazy">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div class="type-tag"><?php echo e($buku->kategori->nama); ?></div>
                    </div>
                    <div class="info-box">
                        <div class="title-txt text-truncate"><?php echo e($buku->judul); ?></div>
                        <div class="author-txt text-truncate">
                            <i class="bi bi-person-circle" style="font-size: 10px;"></i>
                            <?php echo e($buku->penulis ?? 'Karya Ilmiah'); ?>
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\perpustakaan\index.blade.php ENDPATH**/ ?>