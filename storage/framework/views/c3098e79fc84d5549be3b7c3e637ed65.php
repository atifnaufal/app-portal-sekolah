...
<div class="f-shell">
    <div class="f-hero">
        <a href="<?php echo e(route('pengumuman.index')); ?>" class="f-back"><i class="bi bi-arrow-left"></i> Kembali</a>
        <div class="f-title-wrap" style="text-align:right;">
            <span class="f-eyebrow"><i class="bi bi-megaphone-fill"></i> Siarkan Informasi</span>
            <h1 class="f-main-title"><?php echo e($pengumuman->exists ? 'Edit Pengumuman' : 'Buat Pengumuman'); ?></h1>
    ...
    <form class="f-card" method="POST" action="<?php echo e($pengumuman->exists ? route('pengumuman.update', $pengumuman) : route('pengumuman.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="f-sec">
            ...
            <input type="hidden" name="target" id="targetInput" value="<?php echo e($currentTarget); ?>">
            <div class="f-targets">
                <?php $__currentLoopData = $opts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="f-target <?php echo e($currentTarget === $o['v'] ? 'on' : ''); ?>" data-v="<?php echo e($o['v']); ?>">
                        <span class="t-ico"><i class="bi <?php echo e($o['i']); ?>"></i></span>
                        <span style="min-width:0;">
                            <b><?php echo e($o['t']); ?></b>
                            <span><?php echo e($o['d']); ?></span>
                        </span>
        ...
        <div class="f-sec d-none" id="privateBox">
            ...
            <div class="f-chips" id="siswaChips">
                <?php $__currentLoopData = $siswaList ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $on = in_array($s->id, old('siswa_ids', $selectedSiswa ?? []), true); ?>
                    <label class="f-chip <?php echo e($on ? 'on' : ''); ?>">
                        <input type="checkbox" name="siswa_ids[]" value="<?php echo e($s->id); ?>" class="d-none" <?php echo e($on ? 'checked' : ''); ?>>
                        <span class="c-av"><?php echo e(strtoupper(substr($s->name, 0, 1))); ?></span>
                        <span class="c-name"><?php echo e($s->name); ?></span>
        ...
        <div class="f-sec">
            ...
            <input name="judul" value="<?php echo e(old('judul',$pengumuman->judul)); ?>" class="f-input" required maxlength="255"
        ...
        <div class="f-sec">
            ...
            <textarea name="isi" rows="6" class="f-textarea" required
                      placeholder="Tuliskan detail informasi di sini..."><?php echo e(old('isi',$pengumuman->isi)); ?></textarea>
        </div>
        ...
        <div class="f-sec">
            <div class="f-row2">
                <div>
                    ...
                    <input name="tanggal_acara" type="date" value="<?php echo e(old('tanggal_acara',$pengumuman->tanggal_acara?->format('Y-m-d'))); ?>" class="f-input">
                </div>
                <div>
        ...
        <div class="f-sec">
            <label class="f-chip" style="width:100%;">
                <input name="is_landing" type="checkbox" value="1" id="is_landing" class="d-none" <?php if(old('is_landing',$pengumuman->is_landing)): echo 'checked'; endif; ?>>
...
<script>
(function () {
    var currentTa = <?php echo json_encode($currentTarget); ?>;
