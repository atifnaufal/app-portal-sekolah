...
<head>
    ...
    <title><?php echo e($title ?? 'Portal Sekolah'); ?></title>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        body {
            ...
            padding-bottom: <?php echo e((isset($hideNav) && $hideNav) ? '20px' : '110px'); ?>;
...
<body>
    <div id="page-loader">
        <img src="<?php echo e(asset('logo_sekolah.png')); ?>" class="loader-logo" alt="Logo" onerror="this.style.display='none'">
    </div>
    ...
    <nav class="bottom-nav">
        <a class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
            <i class="bi bi-house-door nav-icon"></i>Beranda
        </a>
        <a class="<?php echo e(request()->routeIs('absensi.*') ? 'active' : ''); ?>" href="<?php echo e(route('absensi.index')); ?>">
            <i class="bi bi-calendar-check nav-icon"></i>Absen
        </a>
        <a class="<?php echo e(request()->routeIs('chat.*') ? 'active' : ''); ?>" href="<?php echo e(route('chat.index')); ?>">
            <i class="bi bi-chat-dots nav-icon"></i>Chat
        </a>
        <a class="<?php echo e(request()->routeIs('tugas.*') ? 'active' : ''); ?>" href="<?php echo e(route('tugas.index')); ?>">
            <i class="bi bi-journal-text nav-icon"></i>Tugas
        </a>
        <a class="<?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>" href="<?php echo e(route('profile.show')); ?>">
    ...
    <audio id="notif-sound" src="<?php echo e(asset('sounds/doorbell.mp3')); ?>" preload="auto"></audio>
    ...
    <script>
        ...
        <?php if(session('success') || session('error')): ?>
            showNotification('Informasi', '<?php echo e(session('success') ?: session('error')); ?>');
        <?php endif; ?>
    </script>
    ...
    <script>
        ...
        (function () {
            var SESSION_URL = "<?php echo e(route('session.status')); ?>";
            var POLL_URL = "<?php echo e(route('notifications.poll')); ?>";
            ...
            if (window.Echo) {
                var myId = <?php echo json_encode((int) session('user_id'), 15, 512) ?>;
                try {
...
<?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\layouts\mobile-app.blade.php ENDPATH**/ ?>