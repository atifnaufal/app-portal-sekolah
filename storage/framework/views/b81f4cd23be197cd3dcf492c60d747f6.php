    ...
    <header class="mobile-hero" style="border-radius: 0 0 32px 32px; margin-bottom: 24px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 32px 24px 40px; box-shadow: 0 15px 35px rgba(15, 23, 42, 0.15);">
        <div class="eyebrow" style="color: rgba(255,255,255,0.6); font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.12em;">
            <?php if($isGuru): ?>
                MANAJEMEN AKADEMIK
            <?php else: ?>
                <?php echo e($user->kelas?->nama ?? 'INFORMASI AKADEMIK'); ?>

            <?php endif; ?>
        </div>
        <div class="hero-title mt-2 text-white" style="font-size: 26px; font-weight: 800; letter-spacing: -0.02em;"><?php echo e($isGuru ? 'Penilaian Siswa' : 'Laporan Nilai'); ?></div>
        <?php if($isGuru && $managedClass): ?>
            ...
            <script>
                function goRecap(type) {
                    ...
                    var base = '<?php echo e(route('nilai.recap', $managedClass->id)); ?>';
        ...
        <div class="mt-2" style="font-size: 12px; color: rgba(255,255,255,0.7); line-height: 1.6;">
            <?php echo e($isGuru ? 'Monitor dan evaluasi performa akademik siswa di kelas Anda secara real-time.' : 'Rekapitulasi pencapaian tugas, UTS, dan UAS Anda sepanjang semester ini.'); ?>
    ...
    <main class="mobile-content px-3">
        <?php if($isGuru): ?>
            <?php if(!$selectedSubject): ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $mataPelajarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('nilai.index', ['subject_id' => $mp->id])); ?>" class="card ai-card text-decoration-none text-dark" style="animation: slideUp 0.4s ease both;">
                        <div class="card-body p-3 d-flex align-items-center gap-3">
                            <div class="subject-icon" style="background: linear-gradient(135deg, #f1f5f9, #e2e8f0);">
                                <i class="bi bi-journal-text text-primary"></i>
                            </div>
                            <div class="flex-grow-1">
                                <div class="fw-bold" style="font-size: 15px; color: #1e293b;"><?php echo e($mp->nama); ?></div>
                                <div class="small text-muted fw-semibold" style="font-size: 11px;"><?php echo e($mp->kelas?->nama ?? 'Umum'); ?> · <?php echo e($mp->kode); ?></div>
                            </div>
            ...
            <?php else: ?>
                <div class="d-flex align-items-center justify-content-between mb-4 px-2 py-3 bg-white rounded-4 border shadow-sm">
                    <div>
                        <div class="fw-bold" style="font-size: 15px;"><?php echo e($selectedSubject->nama); ?></div>
                        <div class="small text-muted fw-semibold"><?php echo e($selectedSubject->kelas?->nama ?? 'Semua Kelas'); ?></div>
                    </div>
                    <a href="<?php echo e(route('nilai.index')); ?>" class="btn btn-primary btn-sm rounded-pill px-3 fw-bold shadow-sm">Ganti Mapel</a>
                </div>
                ...
                <div class="ai-card mb-4" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color:#fff; overflow:hidden;">
                    <div class="card-body p-4">
                        ...
                        <div class="small mb-3" style="color:rgba(255,255,255,.65);">
                            Unduh rekap nilai siswa untuk mapel <b class="text-white"><?php echo e($selectedSubject->nama); ?></b> dalam format PDF atau Excel.
                        </div>
                ...
                <script>
                    function goRecapMapel(type) {
                        ...
                        var base = '<?php echo e(route('nilai.recap.mapel', $selectedSubject->id)); ?>';
                        window.open(base + (type === 'excel' ? '/excel' : '') + '?semester=' + sem, '_blank');
                    }
                </script>

                <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <button type="button" class="btn btn-primary btn-sm rounded-pill px-3"
                                    onclick="openInputNilai(<?php echo json_encode($siswa, 15, 512) ?>, <?php echo json_encode($siswa->nilai_records->values()->all(), 15, 512) ?>)">
                                    Input
                                </button>
                            </div>
                            <div class="row g-2">
                                <div class="col-4">
                                    <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                        <div class="fw-black text-primary" style="font-size: 15px;"><?php echo e($nilaiRecord->tugas ?? '-'); ?></div>
                                        <div class="text-muted fw-bold" style="font-size: 8px; text-transform: uppercase;">Tugas</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                        <div class="fw-black text-primary" style="font-size: 15px;"><?php echo e($nilaiRecord->uts ?? '-'); ?></div>
                                        <div class="text-muted fw-bold" style="font-size: 8px; text-transform: uppercase;">UTS</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                        <div class="fw-black text-primary" style="font-size: 15px;"><?php echo e($nilaiRecord->uas ?? '-'); ?></div>
        ...
        <?php else: ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $nilais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mpId => $mpNilais): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="card ai-card" style="animation: slideUp 0.4s ease both;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <h3 class="fw-bold mb-1" style="font-size: 16px; color: #1e293b;"><?php echo e($mp->nama); ?></h3>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-light text-muted border fw-bold" style="font-size: 9px;">SEMESTER <?php echo e($mpNilais->first()->semester); ?></span>
                                    <span class="small text-muted fw-bold" style="font-size: 10px;">KKM: <?php echo e($mp->kkm ?? 75); ?></span>
                                </div>
                            </div>
                            <div class="grade-badge shadow-sm border" style="background: <?php echo e($bgColor); ?>; color: <?php echo e($textColor); ?>; border-color: rgba(0,0,0,0.05) !important;">
                                <?php echo e(round($avg)); ?>
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                    <div class="fw-black" style="font-size: 15px; color: #1e293b;"><?php echo e($mpNilais->avg('tugas') ?: '-'); ?></div>
                                    <div class="text-muted fw-extrabold" style="font-size: 9px; text-transform: uppercase;">Tugas</div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                    <div class="fw-black" style="font-size: 15px; color: #1e293b;"><?php echo e($mpNilais->avg('uts') ?: '-'); ?></div>
                                    <div class="text-muted fw-extrabold" style="font-size: 9px; text-transform: uppercase;">UTS</div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="text-center p-2 rounded-4" style="background: #f8fafc;">
                                    <div class="fw-black" style="font-size: 15px; color: #1e293b;"><?php echo e($mpNilais->avg('uas') ?: '-'); ?></div>
...
<?php if($isGuru && $selectedSubject): ?>
    <div class="tugas-modal" id="inputNilaiModal" onclick="if(event.target===this)closeInputNilai()">
        <div class="tugas-modal-card">
            ...
            <form action="<?php echo e(route('nilai.upsert')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="siswa_id" id="modalSiswaId">
                <input type="hidden" name="mata_pelajaran_id" value="<?php echo e($selectedSubject->id); ?>">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="tahun_ajaran" id="modalTahunAjaranInput" value="<?php echo e($selectedSubject->kelas?->tahun_ajaran ?? ''); ?>" class="form-control rounded-4 border-2" placeholder="2025/2026">
                    </div>
                </div>
