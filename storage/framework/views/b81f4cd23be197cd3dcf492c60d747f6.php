...
<div class="page-container">
    <header class="mobile-hero" style="border-radius: 0 0 32px 32px; margin-bottom: 24px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 32px 24px 40px; box-shadow: 0 15px 35px rgba(15, 23, 42, 0.15);">
        ...
        <?php if($isGuru && $managedClass): ?>
            <div class="mt-3">
                <a href="<?php echo e(route('nilai.recap', $managedClass->id)); ?>" class="btn btn-warning btn-sm rounded-pill px-3 fw-bold shadow-sm">
                    <i class="bi bi-file-earmark-pdf-fill me-1"></i> Cetak Rekap Kelas <?php echo e($managedClass->nama); ?>
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <button type="button" class="btn btn-primary btn-sm rounded-pill px-3"
                                    onclick="openInputNilai(<?php echo json_encode($siswa, 15, 512) ?>, <?php echo json_encode($nilaiRecord, 15, 512) ?>)">
                                    Input
                                </button>
                            </div>
                            <div class="row g-2">
