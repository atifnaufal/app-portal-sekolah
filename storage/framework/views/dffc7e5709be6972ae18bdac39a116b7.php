...
<div class="book-detail-shell">
    <div class="nav-bar-premium" id="proNav">
        <a href="<?php echo e(route('perpustakaan.index')); ?>" class="btn-circle-blur">
            <i class="bi bi-arrow-left"></i>
        </a>
        <div class="fw-bolder d-none" id="navBookTitle" style="font-size: 15px; color: #0f172a;"><?php echo e($buku->judul); ?></div>
    ...
    <div class="hero-backdrop">
        <div class="cover-premium">
            <?php if($buku->cover): ?>
                <img src="<?php echo e(asset('storage/'.$buku->cover)); ?>" alt="Cover">
            <?php else: ?>
    ...
    <div class="meta-box-container">
        <div class="meta-card-item">
            <div class="meta-val-txt"><?php echo e($buku->tahun_terbit ?? 'N/A'); ?></div>
            <div class="meta-lbl-txt">Tahun</div>
        </div>
        <div class="meta-card-item">
            <div class="meta-val-txt text-truncate" style="max-width: 80px;"><?php echo e($buku->penerbit ?? 'Intellectual'); ?></div>
            <div class="meta-lbl-txt">Penerbit</div>
        </div>
        <div class="meta-card-item">
            <div class="meta-val-txt"><?php echo e($buku->kategori->nama); ?></div>
            <div class="meta-lbl-txt">Topik</div>
        </div>
    </div>

    <div class="main-content-pro">
        <h1 class="b-title-txt"><?php echo e($buku->judul); ?></h1>
        <div class="b-author-txt">
            <i class="bi bi-person-check-fill"></i>
            <?php echo e($buku->penulis ?? 'Intellectual Author'); ?>
        ...
        <div class="synopsis-wrapper">
            ...
            <div class="synopsis-body">
                <?php echo e($buku->deskripsi ?: 'Buku ini merupakan karya literatur digital berkualitas tinggi yang dikurasi khusus untuk mendukung ekosistem pembelajaran cerdas di sekolah. Silakan akses versi digital lengkapnya untuk mendalami wawasan intelektual yang terkandung di dalamnya.'); ?>
    ...
    <div class="bottom-action-shell">
        <div class="mobile-shell mx-auto">
            <a href="<?php echo e(route('perpustakaan.read', $buku->slug)); ?>" class="btn-read-pro">
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\perpustakaan\show.blade.php ENDPATH**/ ?>