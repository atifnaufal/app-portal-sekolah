...
<head>
    <meta charset="UTF-8">
    <title>Rekap Nilai <?php echo e($kelas->nama); ?> - Semester <?php echo e($semester); ?></title>
    <style>
...
<body>
    ...
    <div class="judul">
        ...
        <div class="meta">Kelas <?php echo e($kelas->nama); ?> &bull; Semester <?php echo e($semester); ?> &bull; Tahun Ajaran <?php echo e($tahunAjaran ?? ($kelas->tahun_ajaran ?? '-')); ?></div>
        <div class="meta">Wali Kelas: <?php echo e($kelas->pembina->name ?? '-'); ?></div>
    </div>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="<?php echo e($mapels->count() + 4); ?>">Belum ada data siswa.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
    ...
    <div class="footer">
        ...
        <div class="sig">
            <?php echo e($kelas->tahun_ajaran ?? '' ? date('F Y') : ''); ?>

            <div>Mengetahui,<br>Wali Kelas,</div>
            <div class="nama"><?php echo e($kelas->pembina->name ?? '..........................'); ?></div>
            <div>NIP. ..........................</div>
        </div>
    </div>
</body>
