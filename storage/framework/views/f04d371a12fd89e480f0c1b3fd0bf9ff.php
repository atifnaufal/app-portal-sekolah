        ...
        <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-switch p-3 bg-light rounded-4 border d-flex justify-content-between align-items-center">
                    ...
                    <input class="form-check-input ms-0" type="checkbox" name="attendance_active" value="1" <?php echo e($attendanceActive ? 'checked' : ''); ?> style="transform: scale(1.3)">
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    ...
                    <input type="time" name="attendance_start_time" value="<?php echo e($startTime); ?>" class="form-control rounded-3">
                </div>
                <div class="col-6">
                    <label class="form-label small fw-bold">Jam Selesai</label>
                    <input type="time" name="attendance_end_time" value="<?php echo e($endTime); ?>" class="form-control rounded-3">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-switch p-3 bg-light rounded-4 border d-flex justify-content-between align-items-center">
                    ...
                    <input class="form-check-input ms-0" type="checkbox" name="registration_guru_enabled" value="1" <?php echo e($registrationGuruEnabled ? 'checked' : ''); ?> style="transform: scale(1.3)">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-switch p-3 bg-light rounded-4 border d-flex justify-content-between align-items-center">
                    ...
                    <input class="form-check-input ms-0" type="checkbox" name="registration_siswa_enabled" value="1" <?php echo e($registrationSiswaEnabled ? 'checked' : ''); ?> style="transform: scale(1.3)">
                </div>
            </div>
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\admin-settings.blade.php ENDPATH**/ ?>