...
<div class="container">
    <div class="card register-card mx-auto">
        ...
        <div class="register-body">
            ...
            <form method="POST" action="<?php echo e(route('register.store')); ?>" id="regForm">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                    <label class="form-label">Daftar sebagai</label>
                    <select name="role" class="form-select" required>
                        <option value="">Pilih peran...</option>
                        <?php if($guruEnabled): ?> <option value="guru" <?php if(old('role')==='guru'): echo 'selected'; endif; ?>>Guru / Tenaga Pengajar</option> <?php endif; ?>
                        <?php if($siswaEnabled): ?> <option value="siswa" <?php if(old('role')==='siswa'): echo 'selected'; endif; ?>>Siswa / Mahasiswa</option> <?php endif; ?>
                    </select>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input name="nik" value="<?php echo e(old('nik')); ?>" class="form-control" placeholder="16 digit..." required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">WhatsApp Aktif</label>
                        <input name="no_hp" value="<?php echo e(old('no_hp')); ?>" class="form-control" placeholder="08..." required>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Nama Lengkap</label>
                        <input name="name" value="<?php echo e(old('name')); ?>" class="form-control" placeholder="Nama sesuai KTP/Ijazah" required>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <select name="kelas_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $kelases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kelas->id); ?>" <?php if(old('kelas_id')==$kelas->id): echo 'selected'; endif; ?>><?php echo e($kelas->nama); ?> (<?php echo e($kelas->tahun_ajaran); ?>)</option>
            ...
            <div class="text-center pt-3 border-top">
                ...
                <a href="<?php echo e(route('login')); ?>" class="small fw-bold text-decoration-none ms-1 text-primary">Masuk ke Portal</a>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\auth\register.blade.php ENDPATH**/ ?>