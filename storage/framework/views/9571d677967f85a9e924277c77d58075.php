...
<div class="pe-header">
    <a href="<?php echo e(route('profile.show')); ?>" style="width:36px;height:36px;border-radius:50%;background:#f1f5f9;display:flex;align-items:center;justify-content:center;text-decoration:none;color:#475569;">
...
<div class="pe-body">
    ...
    <div class="pe-card" style="text-align:center;">
        <div class="pe-avatar-wrap" id="avatarWrap">
            <?php if($user->foto): ?>
                <img src="<?php echo e(asset('storage/'.$user->foto)); ?>" id="avatarImg"
                    style="object-position: <?php echo e($user->foto_posisi_x ?? 50); ?>% <?php echo e($user->foto_posisi_y ?? 50); ?>%;">
            <?php else: ?>
                <div class="pe-initial" id="avatarInitial"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></div>
        ...
        <div class="pe-pos-hint" id="posHint" style="<?php echo e($user->foto ? '' : 'display:none'); ?>">
    ...
    <div class="pe-card" id="formCard">
        <form id="profileForm" onsubmit="simpanProfil(event)">
            ...
            <div style="margin-bottom:12px;">
                ...
                <input name="name" type="text" class="pe-input" value="<?php echo e(old('name', $user->name)); ?>" required>
            </div>
            <div style="margin-bottom:12px;">
                <label class="pe-label">Email</label>
                <input name="email" type="email" class="pe-input" value="<?php echo e(old('email', $user->email)); ?>" required>
            </div>
            ...
            <input type="hidden" name="foto_posisi_x" id="posisiX" value="<?php echo e($user->foto_posisi_x ?? 50); ?>">
            <input type="hidden" name="foto_posisi_y" id="posisiY" value="<?php echo e($user->foto_posisi_y ?? 50); ?>">
    ...
    <a href="<?php echo e(route('profile.show')); ?>" style="display:block;text-align:center;padding:12px;font-size:13px;font-weight:600;color:#94a3b8;text-decoration:none;">Batal</a>
</div>

<script>
var csrfToken = '<?php echo e(csrf_token()); ?>';
var fotoUrl = <?php echo json_encode($user->foto ? asset('storage/'.$user->foto) : null, 15, 512) ?>;
var posX = <?php echo e($user->foto_posisi_x ?? 50); ?>;
var posY = <?php echo e($user->foto_posisi_y ?? 50); ?>;
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\profile-edit.blade.php ENDPATH**/ ?>