...
<div class="page-container">
    <header class="mobile-hero" style="border-radius: 0 0 40px 40px; margin-bottom: 24px; background: linear-gradient(135deg, #0f172a, #246bfe); padding: 32px 24px 40px;">
        ...
        <p class="mb-3 mt-1" style="font-size: 12px; color: rgba(255,255,255,.7);">
            Rekap kehadiran bulan ini: <strong><?php echo e($totalAbsen); ?> hari</strong>
        </p>
        <div class="stat-grid">
            <div class="stat-chip"><div class="num"><?php echo e($hadir); ?></div><div class="lbl">Hadir</div></div>
            <div class="stat-chip"><div class="num"><?php echo e($sakit); ?></div><div class="lbl">Sakit</div></div>
            <div class="stat-chip"><div class="num"><?php echo e($izin); ?></div><div class="lbl">Izin</div></div>
            <div class="stat-chip"><div class="num"><?php echo e($alpha); ?></div><div class="lbl">Alpha</div></div>
        </div>
    </header>
            ...
            <div class="card absen-card success">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <div class="small text-secondary"><?php echo e(now()->translatedFormat('l, d F Y')); ?></div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6">
                            <div class="p-3 border rounded-4 <?php echo e(($myAttendance && $myAttendance->waktu_masuk) ? 'bg-success-subtle border-success' : 'bg-light border-0'); ?>">
                        ...
                        <div class="col-6">
                            <div class="p-3 border rounded-4 <?php echo e(($myAttendance && $myAttendance->waktu_pulang) ? 'bg-primary-subtle border-primary' : 'bg-light border-0'); ?>">
                    ...
                    <?php if($canMasuk || $canPulang): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('absensi.store')); ?>" enctype="multipart/form-data" id="absensiForm" class="d-none mt-3">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.mobile-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\mobile\absensi.blade.php ENDPATH**/ ?>