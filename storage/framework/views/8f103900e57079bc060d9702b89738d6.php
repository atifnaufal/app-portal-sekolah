...
<div class="recovery-card">
    <div class="p-4 p-md-5">
        ...
        <?php if(session('status')): ?>
            <div class="alert alert-success border-0 rounded-4 small mb-4"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
        ...
        <div class="text-center mt-3">
            <p class="x-small text-muted mb-0">Lupa email Anda? <a href="<?php echo e(route('email.request')); ?>" class="fw-bold text-decoration-none">Cari Email</a></p>
        </div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\laragon\www\app-portal-sekolah\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>