    ...
    <div class="page-container">
        ...
        <main>
            ...
            <div class="section-label">
                ...
                <span class="pill" style="background: #2563eb;"><?php echo e($classGroups->count()); ?></span>
            </div>
            <?php $__empty_1 = true; $__currentLoopData = $classGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('chat.show', $g)); ?>" class="group-item chat-row" data-name="<?php echo e(strtolower($g->name)); ?>" style="animation: fadeIn .3s ease both;">
                    <div class="group-avatar <?php echo e($g->type); ?>">
                        <?php if($g->avatar): ?>
                            <img src="<?php echo e(asset('storage/'.$g->avatar)); ?>">
                        <?php else: ?>
                    ...
                    <div class="group-info">
                        <div class="group-name text-truncate"><?php echo e($g->name); ?></div>
                        <div class="group-last-msg">
                            <?php if($g->lastMessage): ?>
                                <span class="fw-bold text-dark"><?php echo e($g->lastMessage->user_id === $user->id ? 'Anda: ' : (explode(' ', $g->lastMessage->user->name)[0] . ': ')); ?></span>
            ...
            <div class="section-label">
                ...
                <span class="pill" style="background: #8b5cf6;"><?php echo e($eskulGroups->count()); ?></span>
            </div>
