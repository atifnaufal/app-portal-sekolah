...
<div class="p-3 pb-0">
    <a href="<?php echo e(route('profile.show')); ?>" class="text-decoration-none text-muted d-inline-flex align-items-center gap-2 small fw-bold">
...
<main class="mobile-content">
            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
                ...
                <div class="text-center mb-4">
                    <div class="photo-editor mb-3" id="photo-preview">
                        <?php if($user->foto): ?>
                            <img src="<?php echo e(asset('storage/'.$user->foto)); ?>" alt="Preview" id="preview-image">
                        <?php else: ?>
                            <div class="photo-placeholder" id="preview-placeholder"><?php echo e(strtoupper(substr($user->name,0,1))); ?></div>
                ...
                <div class="mb-3">
                    ...
                    <input name="name" value="<?php echo e(old('name',$user->name)); ?>" class="form-control" style="border-radius: 12px;" required>
                </div>

                <div class="mb-4">
                    <label class="form-label x-small fw-bold text-muted">ALAMAT EMAIL</label>
                    <input name="email" type="email" value="<?php echo e(old('email',$user->email)); ?>" class="form-control" style="border-radius: 12px;" required>
    ...
    <a href="<?php echo e(route('profile.show')); ?>" class="btn btn-link w-100 mt-3 text-decoration-none text-muted fw-bold">Batal</a>
</main>
